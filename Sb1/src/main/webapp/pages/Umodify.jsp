...
<body>
	...
	<div style="width: 50%; margin: auto;">
		<div style="float: left">
			<ul>
				<li id="login"><a href="userListPage${cid}"
	...
	<div
		style="text-align: center; margin: auto; top: 0 auto; background-color: #1d1f1d; width: 50%; height: 420px; padding-top: 50px;">
		<form:form action="userModify" modelAttribute="user">
			...
			<ul>
				<li id="signup"><a><input type="SUBMIT" value="Submit"
						id="submit-btn"
						style="background-color: #1d1f1d; border: hidden; color: #ff3860;" /></a>
				</li>
			</ul>
		</form:form>
	</div>
