...
<body>
	...
	<form:form action="/addCorporate" method="post"
		...
		<p>
			...
			<form:input path="corporatename" /><br>
			<form:errors path="corporatename" cssClass="error"/>
		</p>
		<p>
			<label>Corporate Add:&nbsp;&nbsp;&nbsp;</label>
			<form:input path="corporateadd" /><br>
			<form:errors path="corporateadd" cssClass="error"/>
		</p>

		<p>
			<label>Corporate Phno:&nbsp;</label>
			<form:input path="corporatephno" /><br>
			<form:errors path="corporatephno" cssClass="error"/>
		</p>
		<ul>
		<li id="signup">
