		...
		<c:forEach var="row" items="${list}">
			<tbody id="geeks">
				<tr>
					...
					<td>${row.phno}</td>
					<td>${row.dept}</td>
					<td><a href="userModifyPage?uid=${row.username}&cid=${row.corporateid}" style="color: #00FA9A;">Modify</a></td>
					<td><a href="userDelete?cid=${row.corporateid}&uid=${row.username}" style="color: #498afb;">Delete</a></td>
				</tr>
			</tbody>
		</c:forEach>
	</table>
